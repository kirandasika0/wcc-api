...
public class AdminController {
    ...
    public Admin updateAdminDetails(@PathVariable Long adminId, @RequestBody Admin adminIn) {
        ...
        currAdmin.setUsername((adminIn.getUsername() != null) ?
                adminIn.getUsername() : currAdmin.getUsername());
        currAdmin.setPassword(adminIn.getPassword() != null ?
                adminIn.getPassword() : currAdmin.getPassword());
        currAdmin.setPerms(adminIn.getPerms() != null ?
                adminIn.getPerms() : currAdmin.getPerms());
